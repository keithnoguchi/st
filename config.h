 ...
 */
static char font[] = "Liberation Mono:pixelsize=18:antialias=true:autohint=true:bold";
...
static Shortcut shortcuts[] = {
	...
	{ ControlMask|ShiftMask,XK_K,           xzoom,          {.f = +10} },
	{ ControlMask|ShiftMask,XK_J,           xzoom,          {.f = -10} },
